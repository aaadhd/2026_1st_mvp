...
export const ARTISTS_DB = {
    EMOTION: [
        {
            id: 'YIAM', title: '따뜻한 이암', sub: '애착', gameTitle: '모견도 퍼즐', color: '#fb7185', textColor: '#e11d48', artistEmoji: '👨‍🎨', gameEmoji: '🐕', artistImg: 'images/painters/정서_따뜻한 이암.png', mechanic: 'PUZZLE_JIGSAW', desc: '흩어진 조각을 맞추며 집중력과 성취감을 느껴보세요.',
        ...
        {
            id: 'RENOIR', title: '행복한 르누아르', sub: '기쁨', gameTitle: '스마일 캐치', color: '#f472b6', textColor: '#db2777', artistEmoji: '👨‍🎨', gameEmoji: '😊', artistImg: 'images/painters/정서_행복한 르누아르.png', mechanic: 'TOUCH_SMILE', desc: '우울한 표정을 밝은 미소로 바꾸며 긍정 에너지를 채워보세요.',
        ...
        {
            id: 'CHAGALL', title: '꿈꾸는 샤갈', sub: '낭만', gameTitle: '사랑의 비행', color: '#818cf8', textColor: '#4f46e5', artistEmoji: '👨‍🎨', gameEmoji: '💕', artistImg: 'images/painters/정서_꿈꾸는 샤갈.png', mechanic: 'RUN_FLOWER', desc: '자유롭게 하늘을 날며 몽환적인 해방감을 경험해보세요.',
        ...
        {
            id: 'GOGH', title: '강렬한 고흐', sub: '열정', gameTitle: '해바라기 피우기', color: '#eab308', textColor: '#a16207', artistEmoji: '👨‍🎨', gameEmoji: '🌻', artistImg: 'images/painters/정서_강렬한 고흐.png', mechanic: 'SHOOT_WATER', desc: '메마른 꽃에 물을 주며 생명력을 불어넣는 보람을 느껴보세요.',
        ...
        {
            id: 'PAULA', title: '순수한 파울라', sub: '조화', gameTitle: '과일 탑 쌓기', color: '#fb923c', textColor: '#ea580c', artistEmoji: '👩‍🎨', gameEmoji: '🍎', artistImg: 'images/painters/정서_순수한 파울라.png', mechanic: 'BALANCE_STACK', desc: '과일이 무너지지 않게 조심스럽게 쌓으며 균형과 조화를 느껴보세요.',
    ...
    COGNITION: [
        {
            id: 'ARCIMBOLDO', title: '기발한 아르침볼도', sub: '창의', gameTitle: '얼굴 꾸미기', color: '#f97316', textColor: '#c2410c', artistEmoji: '👨‍🎨', gameEmoji: '🍇', artistImg: 'images/painters/인지_기발한 아르침볼도.png', mechanic: 'STICKER_FACE', desc: '서로 다른 사물을 조합해 새로운 형태를 만들며 인지적 유연성을 기르세요.',
        ...
        {
            id: 'MONET_COG', title: '관찰의 모네', sub: '집중', gameTitle: '수련 관찰', color: '#60a5fa', textColor: '#2563eb', artistEmoji: '👨‍🎨', gameEmoji: '🪷', artistImg: 'images/painters/인지_관찰의 모네.png', mechanic: 'OBSERVE_MATCH', desc: '꽃의 미세한 차이를 찾아내며 깊은 관찰력과 집중력을 기르세요.',
        ...
        {
            id: 'CAILLEBOTTE', title: '질서의 카유보트', sub: '체계', gameTitle: '과일 정리', color: '#10b981', textColor: '#047857', artistEmoji: '👨‍🎨', gameEmoji: '🧺', artistImg: 'images/painters/인지_질서의 카유보트.png', mechanic: 'SWIPE_SORT', desc: '사물을 기준에 맞춰 분류하며 논리적 사고와 정돈 습관을 기르세요.',
        ...
        {
            id: 'SEURAT', title: '치밀한 쇠라', sub: '구성', gameTitle: '점 잇기', color: '#14b8a6', textColor: '#0f766e', artistEmoji: '👨‍🎨', gameEmoji: '⚫', artistImg: 'images/painters/인지_치밀한 쇠라.png', mechanic: 'TRACE_DOT', desc: '순서대로 점을 이으며 인내심과 시각-운동 협응력을 키워보세요.',
        ...
        {
            id: 'DAVINCI', title: '탐구하는 다빈치', sub: '해독', gameTitle: '대칭 그리기', color: '#64748b', textColor: '#334155', artistEmoji: '👨‍🎨', gameEmoji: '✍️', artistImg: 'images/painters/인지_탐구하는 다빈치.png', mechanic: 'DRAW_MIRROR', desc: '반대쪽 그림을 유추하여 완성하며 공간 지각력을 훈련해보세요.',
    ...
    SOCIAL: [
        {
            id: 'SAIMDANG', title: '섬세한 신사임당', sub: '교감', gameTitle: '초충도 꾸미기', color: '#16a34a', textColor: '#166534', artistEmoji: '👩‍🎨', gameEmoji: '🦋', artistImg: 'images/painters/사회_섬세한 신사임당.png', mechanic: 'STICKER_NATURE', desc: '풀벌레들의 조화로운 어울림을 표현하며 자연과의 교감을 느껴보세요.',
        ...
        {
            id: 'TISSOT', title: '유쾌한 티소', sub: '기억', gameTitle: '소풍 준비', color: '#f43f5e', textColor: '#be123c', artistEmoji: '👨‍🎨', gameEmoji: '🧺', artistImg: 'images/painters/사회_유쾌한 티소.png', mechanic: 'LIST_MEMO', desc: '친구들을 위한 준비물을 챙기며 배려심과 기억력을 함께 키워보세요.',
        ...
        {
            id: 'YUNBOK', title: '풍류의 신윤복', sub: '통찰', gameTitle: '숨은 연인 찾기', color: '#0891b2', textColor: '#155e75', artistEmoji: '👨‍🎨', gameEmoji: '💑', artistImg: 'images/painters/사회_풍류의 신윤복.png', mechanic: 'FIND_HIDDEN', desc: '복잡한 상황 속에서 맥락을 파악하고 대상을 찾는 통찰력을 기르세요.',
        ...
        {
            id: 'BRUEGEL', title: '이야기꾼 브뤼겔', sub: '사회', gameTitle: '마을 축제', color: '#b45309', textColor: '#78350f', artistEmoji: '👨‍🎨', gameEmoji: '🎉', artistImg: 'images/painters/사회_이야기꾼 브뤼겔.png', mechanic: 'FIND_PERSON', desc: '다양한 사람들의 표정을 살피며 사회적 상황을 이해하는 눈을 기르세요.',
        ...
        {
            id: 'BONNARD', title: '다정한 보나르', sub: '배려', gameTitle: '고양이 밥 주기', color: '#f97316', textColor: '#c2410c', artistEmoji: '👨‍🎨', gameEmoji: '🐱', artistImg: 'images/painters/사회_다정한 보나르.png', mechanic: 'TIMING_FISH', desc: '상대의 움직임을 살피고 타이밍을 맞추며 타인에 대한 관심을 표현하세요.',
    ...
    SENSORY: [
        {
            id: 'MACKE', title: '색채의 마케', sub: '시각', gameTitle: '동물 색칠', color: '#38bdf8', textColor: '#0284c7', artistEmoji: '👨‍🎨', gameEmoji: '🦁', artistImg: 'images/painters/감각_색채의 마케.png', mechanic: 'COLORING_FILL', desc: '다채로운 색을 입히며 시각적 즐거움과 심리적 안정을 찾아보세요.',
        ...
        {
            id: 'MATISSE', title: '야수의 마티스', sub: '촉각', gameTitle: '종이 오리기', color: '#ef4444', textColor: '#b91c1c', artistEmoji: '👨‍🎨', gameEmoji: '✂️', artistImg: 'images/painters/감각_야수의 마티스.png', mechanic: 'COLLAGE_CUTOUT', desc: '손끝으로 형태를 만들고 배치하며 감각적인 즐거움을 느껴보세요.',
        ...
        {
            id: 'KANDINSKY', title: '선율의 칸딘스키', sub: '청각', gameTitle: '소리 드로잉', color: '#a855f7', textColor: '#7e22ce', artistEmoji: '👨‍🎨', gameEmoji: '🎵', artistImg: 'images/painters/감각_선율의 칸딘스키.png', mechanic: 'SOUND_CANVAS', desc: '보이는 것과 들리는 것을 연결하며 공감각적 상상력을 자극해보세요.',
        ...
        {
            id: 'KLIMT_SEN', title: '자연의 클림트', sub: '장식', gameTitle: '황금 정원', color: '#ca8a04', textColor: '#854d0e', artistEmoji: '👨‍🎨', gameEmoji: '✨', artistImg: 'images/painters/감각_자연의 클림트.png', mechanic: 'GOLDEN_BRUSH', desc: '화려한 황금빛으로 화면을 채우며 미적 만족감과 풍요로움을 느껴보세요.',
        ...
        {
            id: 'KLEE', title: '동심의 클레', sub: '공간', gameTitle: '선 따라가기', color: '#92400e', textColor: '#78350f', artistEmoji: '👨‍🎨', gameEmoji: '🏰', artistImg: 'images/painters/감각_동심의 클레.png', mechanic: 'MAZE_DRAG', desc: '길을 잃지 않고 나아가며 공간 지각력과 문제 해결력을 키워보세요.',
